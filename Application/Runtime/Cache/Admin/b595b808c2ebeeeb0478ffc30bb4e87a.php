...
<head>
    ...
    <script src="/shetuanguanli/Public/js/jquery.nicescroll.js" type="text/javascript"></script>
    <script type="text/javascript">
        $(function () {
            ...
            <ul class="nav ace-nav">
                <li class="light-blue"><a data-toggle="dropdown" href="#" class="dropdown-toggle"> <span
                    ...
                    <ul class="user-menu pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
                        ...
                        <li><a href="javascript:void(0)" name="<?php echo U('Admin/Index/admin_info');?>" title="个人信息" class="iframeurl"><i
            ...
            <div id="menu_style" class="menu_style">
                <ul class="nav nav-list" id="nav_list">
                    <li class="home"><a href="javascript:void(0)" name="home.html" class="iframeurl" title=""><i
                            class="icon-list"></i><span class="menu-text"> 系统首页 </span></a></li>
                    <li><a href="#" class="dropdown-toggle"><i class="icon-list"></i><span
                            class="menu-text"> 系部专业 </span><b class="arrow icon-angle-down"></b></a>
                        <ul class="submenu">
                            <li class="home"><a href="javascript:void(0)" name="<?php echo U('Admin/Index/department_list');?>"
                                                title="系部管理" class="iframeurl"><i class="icon-double-angle-right"></i>系部管理</a>
                            </li>
                            <li class="home"><a href="javascript:void(0)" name="<?php echo U('Admin/Index/major_list');?>"
                                                title="专业管理"
                                                class="iframeurl"><i class="icon-double-angle-right"></i>专业管理</a></li>
                        </ul>
                    </li>
                    <li><a href="#" class="dropdown-toggle"><i class="icon-list"></i><span
                            class="menu-text"> 用户管理 </span><b class="arrow icon-angle-down"></b></a>
                        <ul class="submenu">
                            <li class="home"><a href="javascript:void(0)" name="<?php echo U('Admin/Index/user_list');?>" title="用户管理"
                    ...
                    <li><a href="#" class="dropdown-toggle"><i class="icon-list"></i><span
                        ...
                        <ul class="submenu">
                            ...
                            <li class="home"><a href="javascript:void(0)" name="<?php echo U('Admin/Index/admin_info');?>" title="个人信息"
