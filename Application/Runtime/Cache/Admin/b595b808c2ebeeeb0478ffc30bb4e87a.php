...
<head>
	...
	<link rel="stylesheet" href="/shetuanguanli/Public/assets/css/ace-rtl.min.css" />
	<link rel="stylesheet" href="/shetuanguanli/Public/assets/css/ace-skins.min.css" />
	<link rel="stylesheet" href="css/style.css" />
	<!--[if lte IE 8]>
	<link rel="stylesheet" href="/shetuanguanli/Public/assets/css/ace-ie.min.css" />

	<![endif]-->
	<script src="/shetuanguanli/Public/assets/js/ace-extra.min.js"></script>
	<!--[if lt IE 9]>
	<script src="/shetuanguanli/Public/assets/js/html5shiv.js"></script>
	<script src="/shetuanguanli/Public/assets/js/respond.min.js"></script>
	<![endif]-->
	<!--[if !IE]> -->
	<script src="/shetuanguanli/Public/js/jquery-1.9.1.min.js"></script>
	<!-- <![endif]-->
	<!--[if IE]>
	<script type="text/javascript">window.jQuery || document.write("<script src='/shetuanguanli/Public/assets/js/jquery-1.10.2.min.js'>"+"<"+"script>");</script>
	<![endif]-->
	...
	<!--[if lte IE 8]>
	<script src="/shetuanguanli/Public/assets/js/excanvas.min.js"></script>
	<![endif]-->
	<script src="/shetuanguanli/Public/assets/js/ace-elements.min.js"></script>
	<script src="/shetuanguanli/Public/assets/js/ace.min.js"></script>
...
<div class="navbar navbar-default" id="navbar">
	...
	<div class="navbar-container" id="navbar-container">
		<div class="navbar-header pull-left">
			...
			<!--<small>					-->
			<!--<img src="/shetuanguanli/Public/images/logo.png" width="470px">-->
			<!--</small>-->
			<!--</a>&lt;!&ndash; /.brand &ndash;&gt;-->
			<img src="/shetuanguanli/Public/images/潍坊科技学院校徽.png" height="75" width="500" />
		</div>
		<!-- /.navbar-header -->
		...
		<div class="sidebar" id="sidebar">
			...
			<div id="menu_style" class="menu_style">
				<ul class="nav nav-list" id="nav_list">
					...
					<li> <a href="#" class="dropdown-toggle"><i class="icon-list"></i><span class="menu-text"> 交易管理 </span><b class="arrow icon-angle-down"></b></a>
						<ul class="submenu">
					...
					<li> <a href="#" class="dropdown-toggle"><i class="icon-list"></i><span class="menu-text"> 支付管理 </span><b class="arrow icon-angle-down"></b></a>
						<ul class="submenu">
					...
					<li> <a href="#" class="dropdown-toggle"><i class="icon-list"></i><span class="menu-text"> 会员管理 </span><b class="arrow icon-angle-down"></b></a>
						<ul class="submenu">
					...
					<li><a href="#" class="dropdown-toggle"><i class="icon-list"></i><span class="menu-text"> 店铺管理 </span><b class="arrow icon-angle-down"></b></a>
						<ul class="submenu">
					...
					<li><a href="#" class="dropdown-toggle"><i class="icon-list"></i><span class="menu-text"> 文章管理 </span><b class="arrow icon-angle-down"></b></a>
						<ul class="submenu">
					...
					<li><a href="#" class="dropdown-toggle"><i class="icon-list"></i><span class="menu-text"> 系统管理 </span><b class="arrow icon-angle-down"></b></a>
						<ul class="submenu">
					...
					<li><a href="#" class="dropdown-toggle"><i class="icon-list"></i><span class="menu-text"> 管理员管理 </span><b class="arrow icon-angle-down"></b></a>
						<ul class="submenu">
...
<div class="footer_style" id="footerstyle">
	...
	<p class="l_f">制作者：孙肖宁</p>
	<p class="r_f">地址：潍坊科技学院--计算机软件学院</p>
</div>
<!--修改密码样式-->
