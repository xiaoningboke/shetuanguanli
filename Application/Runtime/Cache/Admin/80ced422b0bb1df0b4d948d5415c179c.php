...
<div class="page-content clearfix">
    <div id="Member_Ratings">
      ...
      <ul class="search_content clearfix">
      	<form action="<?php echo U('Admin/Index/user_list');?>" method="post" accept-charset="utf-8" id="chaxun">
            ...
            <div class="table_menu_list">
                <table class="table table-striped table-bordered table-hover" id="sample-table">
                    ...
                    <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
                            ...
                            <a title="编辑" onclick="member_edit('<?php echo ($vo["id"]); ?>','<?php echo ($vo["username"]); ?>','<?php echo ($vo["phone"]); ?>','<?php echo ($vo["email"]); ?>','<?php echo ($vo["name"]); ?>','<?php echo ($vo["identity"]); ?>','<?php echo ($vo["state"]); ?>','<?php echo ($vo["department"]); ?>','<?php echo ($vo["major"]); ?>','<?php echo ($vo["grade"]); ?>','<?php echo ($vo["userclass"]); ?>')"
...
<script>
    ...
    function updateState(id, state) {
        ...
        console.log(data)
        $.ajax({
            url: "<?php echo U('Admin/Index/updateUserState');?>",//请求地址
            data: data,//发送的数据
            type: 'POST',//请求的方式
            success: function (argument) {
                console.log(argument);
    ...
    function member_del(obj, id) {
        ...
        var data = {"id": id};
        $.ajax({
            url: "<?php echo U('Admin/Index/delUser');?>",//请求地址
            data: data,//发送的数据
            type: 'POST',//请求的方式
            success: function (argument) {
                console.log(argument)
