...
<link rel="stylesheet" href="/shetuanguanli/Public/css/login.css">
     ...
     <div class="cnt">
        ...
        <div>
		      <div class="input-group">
			      <span class="input-group-addon"><img src="/shetuanguanli/Public/images/未标题-1_03.png"></span>
			      <input type="text" class="form-control" name="username" placeholder="请输入您的账号">
		      </div><br>
		      <div class="input-group">
			      <span class="input-group-addon"><img src="/shetuanguanli/Public/images/suo.png"></span>
			      <input type="text" class="form-control" name="password" placeholder="请输入您的密码" id="password">
		      </div><br>
		      <div class="input-group">
			      <span class="input-group-addon"><img src="/shetuanguanli/Public/images/suo.png"></span>
			      <input type="text" class="form-control" name="newpassword" placeholder="请输入您的确认密码" id="newpassword">
		      </div><br>
